            ...
            <div class="row">
                ...
                <div class="col-lg-6 form_login">
                    ...
                    <form class="form-signin" method="post" action="actions/login.act.php">
                        ...
                        <input type="email" id="email_login" name="email_login" class="from-control frm_login_email"
                        placeholder="Email" required autofocus>
                        <label for="inputPassword" class="sr-only">Contraseña</label>
                        <input type="password" id="login_password" name="login_password" class="form-control frm_login_pass"
